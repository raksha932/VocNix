...
Next.jsLiveKitTypeScriptTailwindCSS 
License
...
(Or use LiveKit Cloud which offers a free tier with zero installation required).
...
API Diagnostics: http://localhost:3000/api/health
...
VocNix is configured for instant deployment on Vercel:

Push your repository to GitHub.
In the Vercel dashboard, click "Add New Project" and import the repository.
In Settings → Environment Variables, add your production variables (LIVEKIT_URL, LIVEKIT_API_KEY, LIVEKIT_API_SECRET, NEXT_PUBLIC_LIVEKIT_URL, NEXT_PUBLIC_APP_URL).
Click Deploy.
